  ...
  render(){
    let checkUser = (user) => {
      if (!user.thirdParties || user.thirdParties.length === 0) {
        ...
        return <h6 style={{textTransform:'lowercase',marginLeft:'2%'}}>Upcoming Events<Badge badgeContent={this.props.events.length} color='primary'><CalendarTodayTwoTone /></Badge></h6>
